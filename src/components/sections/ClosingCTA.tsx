      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        >
          <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6 leading-tight">
            Ready to Build a Business That Works in a{" "}
          ...
          <p className="font-body text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed">
            Let's design the systems, strategy, and structure your business needs to grow.
          </p>
